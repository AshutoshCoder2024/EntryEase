...
export default function Home() {
  ...
  return (
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-950 text-slate-50 px-4 py-10">
      <div className="w-full max-w-3xl rounded-[2rem] border border-slate-800 bg-slate-900/90 p-10 shadow-2xl shadow-slate-950/70">
        ...
        <h1 className="mt-6 text-4xl font-semibold tracking-tight text-white sm:text-5xl">
          We’re no longer accepting registrations 🚫
        </h1>
        ...
        <p className="mt-4 text-sm leading-7 text-slate-300 sm:text-base">
          ...
          <span className="font-medium text-white">
            {process.env.NEXT_PUBLIC_EVENT_NAME ?? "Living With Ai "}
          </span>.
          Registrations have now been closed. Stay tuned for future events and updates!
        </p>
